...
metaTitle: Setting up AWS Cognito | GitBook Documentation
...
<Steps>
  <Step title="Create a new AWS Cognito application">
    Create an AWS Cognito application from your AWS dashboard.
  </Step>

  <Step title="Install and configure the AWS Cognito integration">
    Install the AWS Cognito integration and add the required configuration.
  </Step>

  <Step title="Configure AWS Cognito for adaptive content (optional)">
