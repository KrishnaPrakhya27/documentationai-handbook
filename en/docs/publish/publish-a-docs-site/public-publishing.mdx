...
metaTitle: Public publishing | GitBook Documentation
...
However you publish your content, you’ll still retain control over who can *edit* your content. And only your primary content branch will be published, so any [change requests](/en/docs/collaborate/change-requests) will remain private until merged.
...
<strong>External search indexing (Web crawlers)</strong>
...
<strong>Search indexing settings follow a hierarchical inheritance pattern:</strong>
