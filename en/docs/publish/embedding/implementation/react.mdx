...
<Steps>
  ...
  <Step title="Import the React components">
  ...
  <Step title="Wrap your app with GitBookProvider">
  ...
  <Step title="Add the GitBookFrame component">
    ...
    <Callout kind="info">
      If you use the Assistant tab, set `allow="clipboard-write"` on the iframe that renders the embed. React integrations leave iframe setup to your app. The standalone [Script tag](/en/docs/publish/embedding/implementation/script) implementation adds this automatically.
    </Callout>
  </Step>

  <Step title="Customize the embed">
  ...
  <Step title="Control the embed with the useGitBook hook">
  ...
  <Step title="Conditionally render the embed">
  ...
  <Step title="Use with Next.js or server-side rendering">
...
<strong>GitBookProvider Props:</strong>
...
<strong>GitBookFrame Props:</strong>
...
Used for [Adaptive Content](/en/docs/publish/adaptive-content) and [Authenticated Access](/en/docs/publish/site-audience/authenticated-access).
