...
metaTitle: Authentication | GitBook Documentation
...
- [Customizing the Embed](/en/docs/publish/embedding/configuration/customizing-docs-embed) – Add welcome messages and actions
- [Creating custom tools](/en/docs/publish/embedding/configuration/creating-custom-tools) – Integrate with your product APIs
- [Docs Embed documentation](/en/docs/publish/embedding) – Complete embedding guide
