...
metaTitle: Submit for review | Developers | GitBook Documentation
...
After [bootstrapping](/en/docs/developers/integrations/quickstart) and [publishing](/en/docs/developers/integrations/publishing) an integration, you’re already able to install and use it [via the install link](/en/docs/developers/integrations/quickstart#install-and-use-your-integration) returned from the CLI.
...
See the [Publishing section](/en/docs/developers/integrations/publishing) to learn more.
...
Once you're happy with your integration, you'll need to provide some metadata with your submission before it's accepted. All metadata can be specified and added in your integration's [`gitbook-manifest.yaml`](/en/docs/developers/integrations/configurations) file, which will be displayed in the integration's listing page after it's published.
