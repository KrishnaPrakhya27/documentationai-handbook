...
<Columns cols={2}>
  <Card title="Create interactive blocks" href="/en/docs/developers/integrations/guides/interactivity" icon="puzzle-piece">
...
<Columns cols={2}>
  ...
  <Card title="Build components" href="/en/docs/developers/integrations/development" icon="puzzle-piece">
