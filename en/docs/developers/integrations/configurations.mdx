...
metaTitle: Configure | Developers | GitBook Documentation
...
| Field | Required | Use it to |
| --- | --- | --- |
| [`name`](#name) | Yes | Set a unique integration identifier. |
| [`title`](#title) | Yes | Set the integration name shown in GitBook. |
| [`description`](#description) | Yes | Describe the integration. |
| [`summary`](#summary) | No | Add Markdown content to the installation page. |
| [`organization`](#organization) | Yes | Identify the organization that owns the integration. |
| [`visibility`](#visibility) | Yes | Control who can install the integration. |
| [`scopes`](#scopes) | Yes | Request GitBook permissions. |
| [`script`](#script) | No | Set the integration entrypoint. |
| [`blocks`](#blocks) | No | Register components in the inline palette. |
| [`categories`](#categories) | No | Categorize the integration. |
| [`icon`](#icon) | No | Add an installation-page icon. |
| [`previewImages`](#preview-images) | No | Add installation-page preview images. |
| [`externalLinks`](#external-links) | No | Add installation-page links. |
| [`configurations`](#configurations) | No | Collect installation settings. |
| [`secrets`](#secrets) | No | Pass environment variables to the manifest. |
...
### Organization<mark>*</mark>

The [`id`](/en/docs/developers/integrations/concepts) or `subdomain` of the organization that owns this integration.
...
| `public` | Members from any organization can install the integration. You need this visibility to [submit your integration to the marketplace](/en/docs/developers/integrations/submit-your-app-for-review)." |
...
The main script to execute for your integration. Should contain the call [`createIntegration()`](/en/docs/developers/integrations/development/runtime#createintegration).
...
Component block(s) referenced by `name` to render in the ( ⌘ + / ) menu. See [`createComponent()`](/en/docs/developers/integrations/development/runtime#createcomponent) to learn more.
...
Button configurations can be used if you need to set up an OAuth connection with a provider in order to use your integration. See [`createOAuthHandler()`](/en/docs/developers/integrations/development/runtime#createoauthhandler) for more information.
