...
<Columns cols={2}>
  ...
  <Card title="Work on your site with an AI agent" href="/en/docs/developers/gitbook-api/guides/work-on-your-site-with-an-ai-agent" icon="robot">
...
<Columns cols={2}>
  <Card title="Create and edit content" href="/en/docs/developers/gitbook-api/api-reference/spaces" icon="file-lines">
