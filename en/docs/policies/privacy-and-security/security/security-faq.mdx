---
title: Security FAQ
metaTitle: Security FAQ | Policies | GitBook Documentation
...
- At rest on **Google Cloud Platform**, using [**multiple layers of AES256-AES128**](https://cloud.google.com/security/encryption-at-rest/default-encryption/resources/encryption-whitepaper.pdf)<strong>.</strong>
...
Yes, we are. You can read more about [security as our company](/en/docs/policies/privacy-and-security/security/security-as-a-company-value#soc-2-type-2) value and our certification on the next page.
