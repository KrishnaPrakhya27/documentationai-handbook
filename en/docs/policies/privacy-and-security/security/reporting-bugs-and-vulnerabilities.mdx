---
title: Reporting bugs and vulnerabilities
description: Learn about how you can report suspected vulnerabilities or security concerns
metaTitle: Reporting bugs and vulnerabilities | Policies | GitBook Documentation
...
To report vulnerabilities, please contact us at [support@gitbook.com](mailto:support@gitbook.com) with a title 'Vulnerability Report'. For all other bugs please provide a specific title relating to the are where the bug occured. To help us respond to you faster, please share the steps to reproduce the behaviour. Our team will triage your report and respond to you with next steps. 
...
We still would like to show our appreciation for your help in making GitBook better and safer by offering you a <strong>discount on your subscription.</strong> 
