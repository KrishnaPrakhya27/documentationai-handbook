---
title: Cookies
metaTitle: Cookies | Policies | GitBook Documentation
...
Analytics or other tracking code are enabled on our mai website ([www.gitbook.com](http://www.gitbook.com)) and domains served and hosted by GitBook (`*.gitbook.io` and custom-domains). If you would like to prevent us from collecting information about your browsing activity on GitBook, you may use a tracking blocker such as Privacy Badgeror opt out of Google Analytics tracking.
