---
title: Skill
description: "Work with GitBook end-to-end: author and format GitBook-flavored Markdown pages and blocks (hints, tabs, steppers); design, scaffold, and configure documentation sites via the GitBook REST API and Git"
metaTitle: Skill | GitBook Documentation
...
Full instructions: [https://gitbook.com/docs/skill/write-docs.md](/en/docs/skill/write-docs)
...
Full instructions: [https://gitbook.com/docs/skill/configure-site.md](/en/docs/skill/configure-site)
...
Full instructions: [https://gitbook.com/docs/skill/write-openapi.md](/en/docs/skill/write-openapi)
...
Full instructions: [https://gitbook.com/docs/skill/cr-create.md](/en/docs/skill/cr-create)
...
Full instructions: [https://gitbook.com/docs/skill/cr-review.md](/en/docs/skill/cr-review)
...
Full instructions: [https://gitbook.com/docs/skill/build-integration.md](/en/docs/skill/build-integration)
