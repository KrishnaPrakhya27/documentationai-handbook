---
title: Notifications
description: Receive notifications about new content, updates to your sections or changes in visibility
...
You can find app notifications at the top of the [sidebar](/en/docs/reference/gitbook-ui#the-sidebar).
