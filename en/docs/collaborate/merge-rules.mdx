...
metaTitle: Merge rules | GitBook Documentation
...
To configure merge rules for your organization, go back to your organization **Home** and click **Settings** <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/ba76c24cf90e5026-spaces-NkEGS7hzeqa35sMXQZ4X-uploads-wkBqgOPry9HAcW4cxJk0-settings.svg?rasterize-bypass=true" alt="" />, under **Admin** in the sidebar. In the settings screen, click **Merge rules** under the **Organization** group. Here you can specify merge rules for your entire organization.
...
To configure merge rules for a section, open the **Actions menu**  in the top left of the editor, and then click **Merge rules**. Here you can specify whether to inherit the merge rules from your organization or configure new ones specific to that section.
...
| <strong>Require Docs Agent review (coming soon)</strong> | Requires a review from the GitBook AI agent. This ensures automated quality checks are performed on content changes before merging. |
...
<strong>Common expression examples:</strong>
