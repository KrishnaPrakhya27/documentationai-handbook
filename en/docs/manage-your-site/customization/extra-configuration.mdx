...
metaTitle: Extra configuration | GitBook Documentation
...
This setting will *not* auto-translate your actual content, but it can help match the interface to the language you’re writing in. To learn more about translating your content, head to the [Translations](/en/docs/gitbook-agent/translations) section.
...
This option does not enable the MCP server itself. The MCP server works only when **Page actions** is enabled. To learn more, see [MCP servers for published docs](/en/docs/ai-for-your-readers/mcp-servers-for-published-docs).

<a id="edit-on-github-gitlab"></a>
...
Enable this option to allow visitors to [export a PDF](/en/docs/publish/pdf-export) of your documentation.

### Privacy policy

In the **Privacy policy** section of the **Configure** tab, you can link to your own privacy policy to help visitors understand how your GitBook content uses cookies and how you protect their privacy. If you choose not to set one, your site will default to [GitBook’s privacy policy](/en/docs/policies/privacy-and-security/statement/cookies).
