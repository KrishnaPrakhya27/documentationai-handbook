...
metaTitle: Configuring the “Test it” button | GitBook Documentation
...
See [Using OpenAPI proxy](/en/docs/create-content/openapi/guides/using-openapi-proxy) for examples.
