...
metaTitle: Tags | GitBook Documentation
...
To view, create and manage tags for your space, open the **Library** from the [table of contents](/en/docs/create-content/content-structure/page#table-of-contents) and choose **Tags**. You can quickly access this by opening the **Tags** menu and selecting **Open Tag Library**.<br /><br />You can also view an individual tag in the library by selecting the tag and choosing **Show in Library**.
