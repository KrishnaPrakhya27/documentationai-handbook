...
metaTitle: Product updates | Changelog | GitBook Documentation
...
<Update label="2026-09-03">
  ...
  <Iframe src="https://www.youtube.com/embed/1ueoIZkQwX8" title="Embedded content" />

  You can now [sync an entire docs site with a single Git repo using Git Sync](/en/docs/docs-as-code/git-sync). This doesn’t just make it easier to import and edit your docs using docs-as-code workflows — it also pairs with new site-level permissions to improve agentic workflows.
  ...
  Head over to [our Git Sync docs](/en/docs/docs-as-code/git-sync) to find out more, or check out [our guide to site-wide Git Sync to set it up for your own docs](/en/docs/guides/editing-and-publishing-documentation/how-to-sync-your-entire-docs-site-with-a-git-repository).
</Update>
...
<Update label="2026-09-02">
  ...
  We’ve also made it possible to include the same GitBook space in multiple places within the navigation. So if you want to list some content in two drop-down [sections](/en/docs/manage-your-site/site-structure/site-sections), you can now do that — without needing to duplicate the content internally and maintain both versions.

  This is great if your nav is organized by use case or reader persona, but you have content that’s relevant to everyone. It’s also useful for [versioned documentation](/en/docs/manage-your-site/site-structure/variants) when there haven’t been any documentation changes.

  All three of these options are available now in [the **Site structure** page](/en/docs/manage-your-site/site-structure), accessible from the left sidebar.
...
<Update label="2026-08-27">
  ...
  We’ve rolled out new [site-level permissions](/en/docs/manage-your-site/site-permissions) that give you more control over what people on your team can do in a live site.
  ...
  <strong>A quick summary of what’s new:</strong>
  ...
  Read more in [our site-level permissions documentation](/en/docs/manage-your-site/site-permissions).

  ### Improvements

  - We’ve simplified the [AI settings for your site](/en/docs/ai-for-your-readers/gitbook-ai-assistant) to a single AI Assistant toggle. You can enable or disable it, and when you enable it you can choose the AI style — either the full Assistant or a more basic AI search.
...
<Update label="2026-08-14">
  ...
  - <strong>View imports panel:</strong> See running and past imports at a glance, each with its source and progress. Stop any import from the panel.
  - <strong>Ask what an import brought in:</strong> GitBook Agent can tell you exactly what landed: the pages, their titles, and their sources.
  - <strong>Safer merges:</strong> Merging is blocked while an import is still writing. A change request can’t be merged with content still missing.
...
<Update label="2026-08-06">
  ...
  <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/894450167965af0f-spaces-PGZZo1PCN4rYgFLPD8Cl-uploads-pQL96NJ5CB0ULb6LhKdE-Developer-tools-2x.png?fm=auto&auto=compress%2Cformat" alt="The developer tools screen" />
...
<Update label="2026-07-29">
  ...
  <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/07562d5ce95a56d1-spaces-PGZZo1PCN4rYgFLPD8Cl-uploads-udbEjIoXcoVc5q4lwYM6-assistant-feedback-2x.png?fm=auto&auto=compress%2Cformat" alt="A screenshot showing GitBook Assistant offering to leave page feedback for a user" />
  ...
  Both types of feedback appear on in your [site’s analytics](/en/docs/analytics/insights) under page feedback.
...
<Update label="2026-07-27">
  ...
  The new [GitBook CLI](/en/docs/docs-as-code/gitbook-cli) (`@gitbook/cli`) brings your GitBook content and organizations to your terminal.
  ...
  Install it globally with `npm install @gitbook/cli -g`, then run `gitbook login` to get started — or head to [the CLI docs](/en/docs/docs-as-code/gitbook-cli) for the full guide.
</Update>
...
<Update label="2026-07-24">
  ...
  <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/33475a4ed44835f6-spaces-PGZZo1PCN4rYgFLPD8Cl-uploads-ErsPWHrpee6BvxcW2BoK-CleanShot-2026-07-29-at.png?fm=auto&auto=compress%2Cformat" alt="" />
...
<Update label="2026-07-23">
  ...
  <Iframe src="https://www.youtube.com/embed/NkPKKhDFUgU" title="Embedded content" />

  We’ve redesigned the GitBook app around what you actually ship: your docs sites.

  You now start at your organization **Home**, and each site’s content, structure, settings, and tools live together in one sidebar. Content in a site lives in [sections](/en/docs/manage-your-site/site-structure/site-sections) — what you knew as spaces, now part of their site — organized into groups when your docs grow. And the new [All content ](/en/docs/create-content/content-structure/all-content)screen gives you one place to find everything in your organization, including content that isn’t part of a site yet.
  ...
  Read about [what’s changed](/en/docs/getting-started/sites-first), or jump into the [quickstart](/en/docs/getting-started/quickstart) to learn more.
</Update>

<Update label="2026-07-21">
  ## Introducing style guides

  You can now create a [style guide](/en/docs/create-content/styleguide) for your docs: a dedicated space for your team’s writing rules that GitBook Agent enforces whenever it writes, edits, or reviews content.
  ...
  Style guides are rolling out gradually in early access. [Learn more in the style guide docs](/en/docs/create-content/styleguide).
</Update>
...
<Update label="2026-07-08">
  ...
  <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/d3864ffce8bdca8f-spaces-PGZZo1PCN4rYgFLPD8Cl-uploads-E1x6r1vIerg6wzfhkbla-MCP.png?fm=auto&auto=compress%2Cformat" alt="" />
...
<Update label="2026-06-23">
  ...
  <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/4fcdb34a0620cb76-spaces-PGZZo1PCN4rYgFLPD8Cl-uploads-aZQO3psoVQOYk2C7vFSO-update-change-request-a.png?fm=auto&auto=compress%2Cformat" alt="A screenshot showing the GitBook API endpoint to update the content of a change request" />

  Use the GitBook API to update page content in a change request. You can send content as Markdown or in GitBook document format, including internal page links. Once submitted, your team can review and merge the changes directly in GitBook — making it easy to automate documentation updates from CI/CD pipelines, scripts, or other external tools.<br /><br />Right now the API supports `update_page`, with more operations coming soon. Check out our [API reference](https://app.gitbook.com/s/2SyQSbIa1iYS7z6Dx5di/gitbook-api) to get started.
...
<Update label="2026-06-16">
  ...
  <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/6dd1d6c8fffd423e-spaces-PGZZo1PCN4rYgFLPD8Cl-uploads-GlET4CXGeTWzZE1PsTnO-multiple-ai-chats-2x.png?fm=auto&auto=compress%2Cformat" alt="A screenshot showing the ‘New chat’ button in GitBook Agent" />
...
<Update label="2026-05-27">
  ...
  <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/7b6ae37194bb1b02-spaces-PGZZo1PCN4rYgFLPD8Cl-uploads-0ej9dO5YPROpwko3s45u-agentineditor.gif?fm=auto&auto=compress%2Cformat" alt='A GitBook editor showing a documentation page titled "System Performance Monitoring." In the bottom-right corner, a "GitBook Agent" button is visible, demonstrating the new inline Agent access point within the editor.' caption="The new Agent button appears in the bottom-right corner of the editor, ready to help without breaking your flow." />
...
<Update label="2026-04-28">
  ...
  <Iframe src="https://www.youtube.com/embed/7OFbfsTHyjw" title="Embedded content" />
  ...
  <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/b0af63d00cc74fc4-spaces-PGZZo1PCN4rYgFLPD8Cl-uploads-7Fha5euZBLmGemyMMtVy-improved-colors-2x.png?fm=auto&auto=compress%2Cformat" alt="" />
...
<Update label="2026-04-24">
  ...
  Today we’re introducing [channels](/en/docs/gitbook-agent/channels) — a new way to bring the power of [GitBook Assistant](/en/docs/ai-for-your-readers/gitbook-ai-assistant) and [GitBook Agent](https://app.gitbook.com/s/NkEGS7hzeqa35sMXQZ4X/gitbook-agent) into other tools and workflows.
  ...
  <Iframe src="https://www.youtube.com/embed/sbDvxsQB5ls" title="Embedded content" />

  When you connect a channel to your GitBook site for support, anyone can tag <strong>@gitbook</strong> and ask a question. GitBook Assistant will answer based on information from your docs (and any [connections](#connections-give-the-assistant-a-full-picture) you've set up).
  ...
  <Iframe src="https://www.youtube.com/embed/rW9Hi-JS0Y0" title="Embedded content" />

  With a channel connected to your GitBook site for collaboration, tagging <strong>@gitbook</strong> will call GitBook Agent. You can give it instructions and the Agent will use the context of the thread, pull request or ticket to create a change request based on your prompt, ready for you to review in the GitBook app.
...
<Update label="2026-04-17">
  ...
  <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/2c26217770f217eb-spaces-PGZZo1PCN4rYgFLPD8Cl-uploads-8M8Rqu5dogYZzRuvR7cD-GitBook-assistant-2x.png?fm=auto&auto=compress%2Cformat" alt="" />
...
<Update label="2026-04-10">
  ...
  <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/f107b5c1625b77b3-spaces-PGZZo1PCN4rYgFLPD8Cl-uploads-LM0lZ9O13GC1q2eI0wOL-tag-improvements.png?fm=auto&auto=compress%2Cformat" alt="" />
...
<Update label="2026-03-31">
  ...
  <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/000649b739338d1a-spaces-PGZZo1PCN4rYgFLPD8Cl-uploads-mji0hAPzGxdBGZHt2muo-ai-insights-2x.png?fm=auto&auto=compress%2Cformat" alt="" />

  With the new [AI insights dashboard](/en/docs/analytics/ai-insights), you can track which topics users ask about most, how many responses led to a real solution, and where the gaps are.
  ...
  <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/e0dc92cade1b3839-spaces-PGZZo1PCN4rYgFLPD8Cl-uploads-eNugXVTlLes3KZjn9WqO-assistant-connections-2.png?fm=auto&auto=compress%2Cformat" alt="" />

  GitBook Assistant is already trained on your docs. And now, with [Connections](/en/docs/ai-for-your-readers/connections), you can pull in external sources too — such as video tutorials and community discussions. So the Assistant has the same context that your best support engineer has, including surrounding knowledge outside your docs.
...
<Update label="2026-03-23">
  ...
  <Iframe src="https://www.youtube.com/embed/nSZtojcjMVE" title="Embedded content" />
  ...
  To copy a page, open the page’s **Actions menu** <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/4fa265378c13a520-spaces-NkEGS7hzeqa35sMXQZ4X-uploads-89MTSo5XRpPMVr1T0rxS-actions.svg?rasterize-bypass=true" alt="" /> from either the table of content or the top of the page and choose **Copy > Copy page**.

  When you then switch to another space or change request, you can click the <strong>Add new +</strong> or <strong>Insert +</strong> buttons in the table of contents and you’ll see the option to paste your copied page.
...
<Update label="2026-03-19">
  ...
  To edit your site’s permissions, head to your site’s Overview page and click the **Permissions** <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/80731eaec01ba414-spaces-PGZZo1PCN4rYgFLPD8Cl-uploads-wLS2uUQuwPGEWXaQF7DG-site-permissions.svg?rasterize-bypass=true" alt="" /> icon in the top-right corner. You can also open your site’s **Settings** tab and select **Manage permissions**.
...
<Update label="2026-03-12">
  ...
  <Iframe src="https://www.youtube.com/embed/-tJ64CkI_bA" title="Embedded content" />
...
<Update label="2026-03-04">
  ...
  <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/898d6c3c6bfdba55-spaces-PGZZo1PCN4rYgFLPD8Cl-uploads-ymXt2N69tGC765iCPMr7-social-accounts-header-.png?fm=auto&auto=compress%2Cformat" alt="A screenshot of a docs site published using GitBook with four social icons in the header bar" />
...
<Update label="2026-02-23">
  ...
  <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/c0475da488f75455-spaces-PGZZo1PCN4rYgFLPD8Cl-uploads-ouw4ii8j40aGmOxDS0ux-reusable-content-dialog.png?fm=auto&auto=compress%2Cformat" alt="" />
  ...
  To change the icon, click the block’s current icon within the hint block to open the icon picker. To change the hint block style (e.g. info, warning or success), open the block’s **Options menu** <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/4c115a43418b42e3-spaces-NkEGS7hzeqa35sMXQZ4X-uploads-aS1QvPIBVYwhpFTGcPBN-options-menu.svg?rasterize-bypass=true" alt="" />
  ...
  - If you’re using conditional content, you can now toggle block conditions on and off more easily from the block’s **Options menu** <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/4c115a43418b42e3-spaces-NkEGS7hzeqa35sMXQZ4X-uploads-aS1QvPIBVYwhpFTGcPBN-options-menu.svg?rasterize-bypass=true" alt="" />.
  - The editor will now remember your code block preferences when you create another code block to save you time. So if you enable Line numbers, With caption, Wrap code, and/or Expandable from the code block’s **Actions menu** <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/4fa265378c13a520-spaces-NkEGS7hzeqa35sMXQZ4X-uploads-89MTSo5XRpPMVr1T0rxS-actions.svg?rasterize-bypass=true" alt="" /> those settings will be maintained when you create another code block.
...
<Update label="2026-02-11">
  ...
  <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/dba697ad1f589f9d-spaces-PGZZo1PCN4rYgFLPD8Cl-uploads-94CRxbjE8PxJUUVdBqHK-inline-assistant-button.png?fm=auto&auto=compress%2Cformat" alt="Search bar and Ask AI bar button variants on a documentation page" />
  ...
  <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/0646ce7a6f5dc096-spaces-PGZZo1PCN4rYgFLPD8Cl-uploads-G4LOb8x4lDivnNkfKHHF-insert-palette-assistan.png?fm=auto&auto=compress%2Cformat" alt="The Insert menu showing options to add a search bar or an Ask AI bar" />
  ...
  - We’ve added a new option to [expandable blocks](https://app.gitbook.com/s/NkEGS7hzeqa35sMXQZ4X/creating-content/blocks/expandable) — you can now have them expanded by default on your site. So if you want expandables to be collapsible, but open when visitors first view your page, you can. The new option is available in the **Block options** <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/4c115a43418b42e3-spaces-NkEGS7hzeqa35sMXQZ4X-uploads-aS1QvPIBVYwhpFTGcPBN-options-menu.svg?rasterize-bypass=true" alt="" /> menu.
...
<Update label="2026-01-29">
  ...
  <Iframe src="https://www.youtube.com/embed/dcFLov32yAQ" title="Embedded content" />
  ...
  Want to set a separate theme for your [API blocks](https://app.gitbook.com/s/NkEGS7hzeqa35sMXQZ4X/api-references)? No problem — you can override them by clicking the **Customize per block type** <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/f3602f14505a063b-spaces-PGZZo1PCN4rYgFLPD8Cl-uploads-sszxJbVwDObQIY2eFDeE-settings---light.svg?rasterize-bypass=true" alt="Customize per block type icon" /> button in the **Customization** screen.
...
<Update label="2026-01-23">
  ...
  <Iframe src="https://www.youtube.com/embed/6WW97Y6Ej0E" title="Embedded content" />
  ...
  <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/419802ee85a67764-spaces-PGZZo1PCN4rYgFLPD8Cl-uploads-Unfr06sjeQipOfltXTDq-social-accounts-2x.png?fm=auto&auto=compress%2Cformat" alt="The Sharing tab in Customization with fields for adding social accounts" />
...
<Update label="2026-01-21">
  ...
  <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/df3cca2df83eb4e8-spaces-PGZZo1PCN4rYgFLPD8Cl-uploads-ajUayCtuD9yWMT8wpRzd-show-in-library-2x.png?fm=auto&auto=compress%2Cformat" alt="The Library panel showing an item you can jump to in Library" />
...
<Update label="2026-01-16">
  ...
  <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/e5b18dd952dcc50a-spaces-PGZZo1PCN4rYgFLPD8Cl-uploads-pAxYdRWvQX2mWuu7hlHB-toc-library-2x.png?fm=auto&auto=compress%2Cformat" alt="The updated table of contents with Pages and Library sections" />
...
<Update label="2026-01-12">
  ...
  <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/c1cd1a32d1f1f9e2-spaces-NkEGS7hzeqa35sMXQZ4X-uploads-FTJDHOlJcYyh2M3tK6Xe-page-actions.png?fm=auto&auto=compress%2Cformat" alt="The Improve menu showing preset prompts for editing a page with AI" />

  You can now tell GitBook Agent to complete common actions using [a new **Improve** menu](https://app.gitbook.com/s/NkEGS7hzeqa35sMXQZ4X/gitbook-agent/write-and-edit-with-ai#improve-page-content-with-gitbook-agent) that offers quick presets to improve your page. You can access the new menu from the editor by hovering over the page title, or from the page’s **Actions menu** <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/4fa265378c13a520-spaces-NkEGS7hzeqa35sMXQZ4X-uploads-89MTSo5XRpPMVr1T0rxS-actions.svg?rasterize-bypass=true" alt="Actions menu icon" />.
