---
title: "How to structure technical documentation: information architecture best practices"
description: Learn information architecture best practices to structure technical documentation — including  API docs, product docs, guides, FAQs, and changelogs — so users can find answers fast
metaTitle: "How to structure technical documentation: information architecture best practices | Guides | GitBook Documentation"
...
While the ultimate goal is to make it easier for [your users to find what they need](/en/docs/guides/docs-workflow-optimization/documentation-personas), it’s just as important that everyone on the team knows how to contribute to your docs, and don’t have to jump through hoops to do it.
...
Depending on the structure you’ve chosen, you can now start grouping content together. That might be clearly-defined [sections](/en/docs/manage-your-site/site-structure/site-sections) for API docs, product docs, guides, and FAQs. Maybe it includes a changelog or a blog.
...
llms.txt gives an overview of your entire site structure in an AI-friendly format, while Markdown support makes it easy for the AI to read each page. Some documentation platforms offer built-in support out of the box.
...
- **Create page groups** – [Group pages together](/en/docs/create-content/content-structure/page#page-groups) under titles to bring related subjects together, and make it easier for your users to find the information they need at a glance.
- **Add pages and subpages** – When a topic is large or you need to add things like technical guides that relate to it directly, add them as [a subpage](/en/docs/create-content/content-structure/page#pages). This creates hierarchy in your docs, but we’d suggest only creating a maximum two levels of subpages — any more and things can become confusin.
- **Use H1-H4 headings** – Add [headings](/en/docs/create-content/blocks/heading) to your page to denote hierarchy within a page’s content. Give each page an H1 heading at the top, then use H2, H3 and H4 headings to break up ideas. Be consistent about how you use them to make it easier to scan a page for information. Some documentation tools use headings to create [an ‘On this page’ section](/en/docs/reference/gitbook-ui#page-outline) that lets you jump between headings fast.
- **Cross-reference** – Linking between related pages is essential. Don’t explain concepts or features on multiple pages — it’s a waste of time, and will become increasingly hard to keep track of and update when things change. Instead, [add links](/en/docs/create-content/blocks/page-link) to direct people to more information if they need it. Consider adding [a link to a word or concept](/en/docs/create-content/formatting/inline#links) the first time it appears on the page, but also adding in dedicated links to related content wherever relevant.
- **Use global search** – When you have multiple kinds of documentation (such as API docs, product docs, FAQs etc) on a single docs site, enabling [global search](/en/docs/create-content/searching-your-content) will help users find what they need without having to click through multiple tabs and pages. Dedicated documentation tools like GitBook [support global search natively](/en/docs/create-content/searching-your-content).
...
A clean structure makes content easier to chunk, retrieve, and cite correctly, which improves AI answers, reduces hallucinations, and [increases your chances of being mentioned by tools like ChatGPT](/en/docs/guides/seo-and-llm-optimization/geo-guide).
...
Check out our guide to learn more about [optimizing your docs for AI](/en/docs/guides/seo-and-llm-optimization/geo-guide).
...
- **Site sections and site section groups** – Add [multiple content spaces to a single site](/en/docs/manage-your-site/site-structure/site-sections) and organize them into a tabbed navigation bar with drop-down groups if needed.
- **Effortless navigation** – GitBook automatically creates a [table of contents](/en/docs/reference/gitbook-ui#table-of-contents) for your docs, with an ‘On this page’ section to make it easy to browse and jump to specific page sections.
- **Global search** – No matter how many kinds of documentation you publish in a single site, you can [search across them all](/en/docs/create-content/searching-your-content) and use Ask AI to find information fast.
- **GitHub and GitLab Sync** – [Sync your content to GitHub or GitLab](/en/docs/docs-as-code/git-sync) so your developers can update your docs from Git, while less technical team members work in the built-in editor.
- **Branch-based workflow** – Encourage collaboration and protect your primary docs with intuitive branching, including [reviews and conflict resolution](/en/docs/collaborate/change-requests).
- **Beautiful out of the box** – Your docs will look incredible in GitBook, even if you just hit publish. But you’ll also get a ton of [customization options](/en/docs/manage-your-site/customization) to build docs that match your brand.
...
And there’s more to GitBook — including [built-in content insights](/en/docs/analytics/insights) and [interactive OpenAPI blocks](/en/docs/create-content/openapi) that let your users test endpoints right on the page. [Try it out for yourself](https://gitbook.com/join) or find out more [on our website](https://www.gitbook.com/).

[<strong>→ Try GitBook for free</strong>](https://gitbook.com/join)

[<strong>→ How to import or migrate your content to GitBook with Git Sync</strong>](/en/docs/guides/editing-and-publishing-documentation/import-or-migrate-your-content-to-gitbook-with-git-sync)

[<strong>→ Combine multiple existing sites into one using site sections</strong>](/en/docs/guides/content-organization-and-localization/combine-multiple-docs-sites-using-sections)
