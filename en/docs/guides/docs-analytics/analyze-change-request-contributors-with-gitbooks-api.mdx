---
title: Analyze change request contributors with GitBook’s API
description: Track creators, reviewers, and contributors with GitBook’s API to understand how your team collaborates
metaTitle: Analyze change request contributors with GitBook’s API | Guides | GitBook Documentation
...
To follow along with this guide, you’ll need [a GitBook account](https://app.gitbook.com/join) with API access and a personal access token. You can [create a token](/en/docs/developers/integrations/quickstart#create-a-personal-access-token) from your GitBook account settings. 
...
```python title="contribution_analytics.py"
...
For technical details about the API endpoints used in this guide, see the [GitBook API documentation](/en/docs/developers/gitbook-api/api-reference).
