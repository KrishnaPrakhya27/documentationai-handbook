---
title: How to personalize your GitBook site using Auth0 and adaptive content
metaTitle: How to personalize your GitBook site using Auth0 and adaptive content | Guides | GitBook Documentation
...
<Callout kind="info">
  You’ll need an [Ultimate site](https://www.gitbook.com/pricing) using [Authenticated Access](/en/docs/publish/site-audience/authenticated-access) with Auth0 to follow this guide.
</Callout>
...
[<strong>→ Explore GitBook’s authenticated access</strong>](/en/docs/publish/site-audience/authenticated-access)
