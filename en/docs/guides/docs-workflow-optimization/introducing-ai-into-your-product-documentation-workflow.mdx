---
title: Introducing AI into your product documentation workflow
description: Discover how you can use AI tools to improve your docs workflow — including its limitations and how to overcome them
metaTitle: Introducing AI into your product documentation workflow | Guides | GitBook Documentation
...
### AI tools and documentation today
...
### The limitations of AI tools for documentation
...
### Introducing an AI product docs workflow
...
#### 3: Integrating AI into your Git documentation workflow
...
- <strong>Retrieval-augmented generation (RAG)</strong> – RAG allows an LLM to access and incorporate up-to-date information in real-time by pulling data from a vector database. This makes it particularly useful for handling rapidly-changing content, such as technical documentation or product updates.
...
[GitBook’s API](/en/docs/developers/gitbook-api/quickstart) also allows you to integrate this data with other platforms. For example, you could build a documentation chatbot in Intercom that enables users to get answers directly from your docs.

### Using GitBook AI in your docs workflow
...
[<strong>→ Get an overview of GitBook AI</strong>](https://www.gitbook.com/solutions/ai)

[<strong>→ Read about writing docs with GitBook AI</strong>](/en/docs/gitbook-agent/write-and-edit-with-ai)
