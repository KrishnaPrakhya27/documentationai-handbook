...
metaTitle: Site analytics | GitBook Documentation
...
<Callout kind="info">
  If you connect **Google Analytics**, your site can show a cookies notice. To remove it, open [**Site settings → Analytics cookie**](/en/docs/manage-your-site/site-settings#analytics-cookie) and disable or remove the **Google Analytics** integration.
</Callout>

<Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/f5af27ad5510cdc2-spaces-NkEGS7hzeqa35sMXQZ4X-uploads-N4B1Zr9tOH4zy0ynbjuf-26_03_30_analytics-2x.png?fm=auto&auto=compress%2Cformat" alt="A GitBook screenshot showing the site analytics dashboard" caption="The site analytics dashboard." />
...
You can use the time filter <Image src="https://test-dai.imgix.net/org-4afef969-21f9-40f3-b5b8-b06c8b6cf68f/doc-22a3b060-9539-4176-97e4-49120e02f5d1/5995e7af18e55747-spaces-NkEGS7hzeqa35sMXQZ4X-uploads-1g9fFv9V674Y7JGjHOGw-calendar.svg?rasterize-bypass=true" alt="" /> on the right of the **Analytics** screen to change the time period between the last 24 hours, 7 days, 30 days or 3 months.
...
<a id="pages-and-feedback"></a>

#### Pages & Feedback

Pages & feedback allow you to see a high-level representation of how your users rate your content. You’ll see an overview of all of your site’s sections and variants, and after enabling [page rating](/en/docs/manage-your-site/site-settings#page-ratings-pro-and-enterprise-plans) in the **Customize** menu for a site, you can see each page’s average feedback rating.
...
The **Authenticated** and **Anonymous** values are meaningful from August 2026 onward. For more detail, see the [authenticated visitor FAQ](#what-does-authenticated-visitor-mean).
...
<Callout kind="info">
  ...
  Claim filters only use claims configured for your site. They do not infer customer identity from page content, sections, or variants. See [enabling adaptive content](/en/docs/publish/adaptive-content/enabling-adaptive-content) to configure visitor claims.
</Callout>
...
<Callout kind="info">
  <strong>Why can’t I see any feedback data for my site?</strong><br />We only display data for published sites with page ratings enabled. If your site is not published or does not have page ratings enabled, you won’t see any analytics data.
</Callout>
...
If a broken link points to a topic that exists somewhere else in your documentation, or you simply want to direct the traffic to your primary docs, you can set up [site redirects](/en/docs/publish/site-redirects) to point those visitors in the right direction.
...
The [Ask AI](/en/docs/create-content/searching-your-content/gitbook-ai) section allows you to see what your users are asking for when using GitBook AI. This insight helps you identify common questions, uncover gaps in your documentation, and improve content to better meet user needs.
...
The [OpenAPI](/en/docs/create-content/openapi) analytics view in GitBook provides insights into how users engage with your API documentation.
...
See how your site content is being accessed through [MCP](/en/docs/ai-for-your-readers/mcp-servers-for-published-docs) integrations. You can view MCP requests over time and see which bots and agents are accessing your site content.

### FAQ

<Expandable title="Who can view site analytics?">
...
<Expandable title="Why is my analytics data not loading?">
...
<Expandable title="What does &quot;Page not found&quot; mean?">
  "Page not found" means visitors tried to open a page on your site that doesn't exist. The table only counts visits to your default Page not found page. To see which URLs are broken, open **Broken URLs** in site analytics — from there you can see how many visitors each broken link had and [create redirects](/en/docs/publish/site-redirects) if needed.
</Expandable>

<Expandable title="What does &quot;Not set&quot; mean in referrer data?">
...
<a id="what-does-authenticated-visitor-mean"></a>

<Expandable title="What does &quot;Authenticated visitor&quot; mean?">
...
<Expandable title="What does &quot;Unknown&quot; mean for authenticated visitors?">
