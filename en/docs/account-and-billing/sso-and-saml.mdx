...
metaTitle: SSO & SAML | GitBook Documentation
...
You must be an [organization admin](/en/docs/collaborate/member-management/roles#admin) to enable SSO for your GitBook organization.‌
