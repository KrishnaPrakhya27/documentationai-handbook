...
metaTitle: Subscription cancellations | GitBook Documentation
...
1. Go to **Organization settings** — click the settings icon at the bottom of the sidebar, then click <strong>[organization name] settings</strong>.
2. Click **Billing**.
3. Click Cancel subscription

### **Cancel plan button missing**

If you've clicked through **Organization settings** → **Billing** and didn't see the **Cancel subscription button**, [contact GitBook Support](#cancel-plan-button-missing). Don't repeat the self-service flow.
